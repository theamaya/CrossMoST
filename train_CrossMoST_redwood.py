...
import models.CrossMoST_models_redwood as models
...
def get_args():
    ...
    parser.add_argument('--pretrain_dataset_name', default='redwood_img_pcl', type=str)
    parser.add_argument('--validate_dataset_name', default='redwood_img_pcl', type=str)
