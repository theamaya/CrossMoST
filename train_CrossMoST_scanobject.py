...
def get_args():
    ...
    parser.add_argument('--pretrain_dataset_name', default='scanobjectnn_img_pcl_h5', type=str)
    parser.add_argument('--validate_dataset_name', default='scanobjectnn_img_pcl_h5', type=str)
