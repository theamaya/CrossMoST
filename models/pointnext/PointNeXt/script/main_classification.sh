...
# load different cfgs for training on different benchmarks (modelnet40_crossmost classification, or scanobjectnn classification) and using different models.
